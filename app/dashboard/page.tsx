    ...
    <div style={{ minHeight: "100vh", background: "#080a18", fontFamily: "'Outfit', sans-serif", color: "#fff" }}>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .live-dot { width:7px; height:7px; border-radius:50%; background:#0BAB6C; animation: pulse-dot 2s ease-in-out infinite; }
        .nav-item {
      ...
      <main style={{ marginLeft: "220px", padding: "36px 40px", position: "relative", zIndex: 1, minHeight: "100vh" }}>
        ...
        {/* Header */}
        <div className="fade-in fade-in-1" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "32px" }}>
          <div>
            <h1 style={{ fontSize: "26px", fontWeight: 800, letterSpacing: "-0.5px", marginBottom: "4px" }}>The Studio</h1>
        ...
        {error && (
          <div style={{
            ...
            ⚠️ {error} —{" "}
            <span style={{ cursor: "pointer", textDecoration: "underline" }} onClick={fetchProjects}>retry</span>
          </div>
        )}

        {/* Stats */}
        {!loading && (
          <div className="fade-in fade-in-2" style={{ display: "flex", gap: "12px", marginBottom: "32px" }}>
            {[
        ...
        {loading && (
          <div style={{ display: "flex", justifyContent: "center", paddingTop: "80px" }}>
            <div style={{
              ...
              border: "2px solid rgba(255,255,255,0.1)", borderTopColor: "#5B4CF5",
        ...
        {!loading && projects.length === 0 && !error && (
          <div className="fade-in fade-in-3" style={{
            ...
            justifyContent: "center", paddingTop: "100px", gap: "16px", textAlign: "center",
          }}>
            <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "16px" }}>
            ...
            {filter === "all" && (
              <div
                ...
                style={{
                  border: "1px dashed rgba(91,76,245,0.3)", background: "rgba(91,76,245,0.04)",
                  display: "flex", flexDirection: "column", alignItems: "center",
